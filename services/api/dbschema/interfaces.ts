...
export interface Log extends std.$Object {
  level: string
  createdAt: number
  error?: string | null
  message?: string | null
...
export interface Post extends std.$Object {
  ...
  couldNotDownload?: boolean | null
  downloadError?: string | null
  downloadedMedia?: string[] | null
  downloadedMediaCount?: number | null
  mediaDownloadTries?: number | null
  mediaHasBeenDownloaded?: boolean | null
  mediaUrl: string
  postId: string
  postMediaImagesHaveBeenProcessed?: boolean | null
  postMediaImagesProcessingError?: string | null
  postThumbnailsCreated?: boolean | null
  postUrl: string
  score: number
  title: string
  subreddit: Subreddit
...
export interface Settings extends std.$Object {
...
export interface Subreddit extends std.$Object {
  subreddit: string
...
export interface SubredditGroup extends std.$Object {
  subGroup: string
  favourited?: boolean | null
